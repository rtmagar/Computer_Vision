...
# A bitwise "OR" examines every pixels in rectangle and circle. If 
# Either pixel in rectangle or circle is greater than zero, then the
# output pixel has a value of 255, otherwise it is 0
