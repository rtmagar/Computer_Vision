...
# image are NumPy arrays, stored as unsigned 8 bit integers -- this
# implies that the values of our pixels will be in the range [0, 255]; when
# using function like cv2.add and cv2.subtract, values will be clipped to 
# this range, even if the added or subtracted values fall outside the range
# of [0, 255], 
...
# Note: if you use Numpy airthmetic operations on these arrays, the value
...
# array filled with 100's, then we simply add the image together; notice how
