...
# thresholding to examine neighbourhood of pixels and adaptively threshold
# each neighbourhood -- in this example, we'll calculate the mean value of the
# neighbourhood area of 25 pixels and threshold based on that value;
# finally, out constant C is subtracted from the mean calculation( in this
# case 15)
...
cv2.imshow("scikit_image Mean Thresh", thresh)
cv2.waitKey(0)
